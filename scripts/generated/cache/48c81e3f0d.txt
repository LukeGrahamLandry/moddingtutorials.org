// this file is part of MultiHitboxLib, available under the MIT License 
// it's a block bench plugin that generates json files that can easily be parsed into definitions for mobs with multiple hitboxes
// i'll link to an example mod implementation at some point
