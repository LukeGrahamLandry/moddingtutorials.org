...
This site has tutorials for versions 1.18.1, 1.17.1, and 1.16.5. You can switch between them by using the drop down menu at the top of the nav bar on the left of each tutorial page. 
